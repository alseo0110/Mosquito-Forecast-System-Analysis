...
### 프로젝트 배경 및 목적
- **동기**: 여름철 모기로 인한 시민들의 불편함을 해결하고, 데이터 분석을 통해 모기 발생 패턴을 파악하고자 함
- **문제 인식**: 기존 모기예보는 단순한 정성적 정보 제공에 그쳤으며, 정량적 예측 모델의 필요성을 느낌
- **학습 목표**: 
